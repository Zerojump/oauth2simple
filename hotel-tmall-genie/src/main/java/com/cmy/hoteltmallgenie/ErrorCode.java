...
public enum ErrorCode {
    ...
    INVALID_ACCESS_TOKEN(6, "access_token无效或已过期。"),
    ...
    ACCESS_TOKEN_FAIL(12, "access_token创建失败"),
    OAUT_CODE_FAIL(13, "授权码创建失败"),
    APP_PERMISSIONS_FAIL(14, "权限不足，范围错误"),
    INVALID_REFRESH_TOKEN(15, "refresh_token失效"),
    REFRESH_TOKEN_FAIL(12, "refresh_token创建失败");
